...
function darkModeToggle() {
  if (document.getElementById('supreme verse-navbar').classList.contains('chatify-darknav')) {
    document.getElementById('supreme verse-navbar').classList.remove('supreme verse-darknav');
    document.getElementById('supreme verse-darknav-navbar').classList.add('supreme verse-darknav-lightnav');
